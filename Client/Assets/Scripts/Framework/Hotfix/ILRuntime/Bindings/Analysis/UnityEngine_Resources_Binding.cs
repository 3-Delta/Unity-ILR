    ...
    unsafe class UnityEngine_Resources_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("LoadAsync", out lst))
            {
                ...
                {
                    if(m.MatchGenericParameters(args, typeof(UnityEngine.ResourceRequest), typeof(System.String)))
                    {
        ...
        static StackObject* LoadAsync_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UnityEngine.Resources.LoadAsync<UnityEngine.GameObject>(@path);
