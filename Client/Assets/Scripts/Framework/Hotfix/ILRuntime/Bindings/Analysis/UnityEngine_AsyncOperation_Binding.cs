...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_AsyncOperation_Binding
    {
        ...
        static StackObject* add_completed_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Action<UnityEngine.AsyncOperation> @value = (System.Action<UnityEngine.AsyncOperation>)typeof(System.Action<UnityEngine.AsyncOperation>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
