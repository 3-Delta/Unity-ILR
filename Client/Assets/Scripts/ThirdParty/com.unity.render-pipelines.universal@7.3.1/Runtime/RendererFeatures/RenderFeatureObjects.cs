...
namespace UnityEngine.Experimental.Rendering.Universal
{
    ...
    [MovedFrom("UnityEngine.Experimental.Rendering.LWRP")]public class RenderFeatureObjects : ScriptableRendererFeature
    {
        [System.Serializable]
        ...
        public override void Create()
        {
            ...
            renderObjectsPass = new RenderObjectsPass(settings.passTag, settings.Event, filter.PassNames, filter.RenderQueueType, filter.LayerMask, settings.cameraSettings);
