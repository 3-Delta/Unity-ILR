...
namespace UnityEngine.Experimental.Rendering.Universal
{
    [MovedFrom("UnityEngine.Experimental.Rendering.LWRP")] public class RenderObjectsPass : ScriptableRenderPass
    {
        ...
        RenderFeatureObjects.CustomCameraSettings m_CameraSettings;
        ...
        public RenderObjectsPass(string profilerTag, RenderPassEvent renderPassEvent, string[] shaderTags, RenderQueueType renderQueueType, int layerMask, RenderFeatureObjects.CustomCameraSettings cameraSettings)
        {
